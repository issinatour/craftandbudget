...
<head>
    ...
    <title>Craftandbudget-Servicios para artesania</title>
...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header page-scroll">
            ...
            <a class="navbar-brand page-scroll" href="#page-top">Craftandbudget</a>
        </div>
...
<header>
    <div class="container">
        <div class="intro-text">
            <div class="intro-lead-in">Bienvenido a craftandbudget</div>
            <div class="intro-heading">Soluciones para Artesania</div>
            <a href="#services" class="page-scroll btn btn-xl">¿Que ofrecemos?</a>
        </div>
    </div>
</header>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                ...
                <h3 class="section-subheading text-muted">Soluciones para la gestion artesanal</h3>
            </div>
        </div>
        <div class="row text-center">
            <div class="col-md-4">
                ...
                <p class="text-muted">Conexion facil con los e-commerce más usados y webs para poner en venta tus productos</p>
            </div>
            <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fa fa-circle fa-stack-2x text-primary"></i>
                ...
                <h4 class="service-heading">Estadisticas</h4>
                <p class="text-muted">Estadisticas de tus productos y materiales en tiempo real y calculadora de rentabilidad</p>
            </div>
            <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fa fa-circle fa-stack-2x text-primary"></i>
                ...
                <p class="text-muted">Todos tus datos estan seguros con nosotros</p>
            </div>
        </div>
    </div>
</section>
...
<section id="team" class="bg-light-gray">
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 class="section-heading">Equipo de desarrolladores</h2>
        ...
        <div class="row">
            ...
            <div class="col-sm-2">
                <div class="team-member">
                    <img src="<?=base_url() ?>assets/images/issamlinkedin.jpg" class="img-responsive img-circle" alt="">
                    <h4>Issam Natour Muñoz</h4>
            ...
            <div class="col-sm-2">
                <div class="team-member">
                    <img src="<?=base_url() ?>assets/images/senegales.jpg" class="img-responsive img-circle" alt="">
                    <h4>Nicolas Alphonse Bertoncello</h4>
                    <p class="text-muted">Desarrollador</p>
                    <ul class="list-inline social-buttons">
                        <li><a href="#"><i class="fa fa-twitter"></i></a>
                        </li>
        ...
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 text-center">
                <p class="large text-muted">Desarrolladores de Craftandbudget</p><p> Tecnologías empleadas: Mysql,Php,Javascript,JQuery,Android,Twitter Bootstrap
                </p>
            </div>
        </div>
    </div>
