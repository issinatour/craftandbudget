                                            ...
                                            <form onsubmit="myFunction()" method="post" class="form-horizontal" action="<?=base_url()?>producto/register_save" enctype="multipart/form-data" >
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6"><input type="text" name="title" class="form-control" value="1"> </div>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <select data-placeholder="Medida" class="chosen-select" style="width:350px;" tabindex="5">

                                                                <?php foreach($measurements as $measuement){ ?>
                                                                    <option <?php if($measuement['is_selected']==1){?>  selected   <?php }else {?>  <?php }?> value="<?=$measuement['measurement_type']?>"><?=strtoupper($measuement['measurement_type']);?></option>
                                                                <?php } ?>
                                                    ...
                                                    <input type="hidden" id="id_product" name="id_product" value="1"/>
