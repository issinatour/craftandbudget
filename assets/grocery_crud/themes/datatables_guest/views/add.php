...
<div class="ibox float-e-margins">
	<div class="ibox-title">
		<h5><?php echo $this->l('form_add'); ?> <?php echo $subject?></h5>
	</div>
		...
		<form class="form-horizontal" method="get">
			...
			$counter = 0;
				foreach($fields as $field)
				{
					...
					$counter++;
			?>
			<div class="form-group"><label class="col-sm-3 control-label"><?php echo $input_fields[$field->field_name]->display_as?><?php echo ($input_fields[$field->field_name]->required)? "<span class='required'>*</span> " : ""?></label>
                <div class="col-sm-9"><?php echo $input_fields[$field->field_name]->input?></div>
            </div>
